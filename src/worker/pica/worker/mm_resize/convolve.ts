...
function clampNegative(i: number) {
  return i >= 0 ? i : 0
}
...
export function convolveHor(
  ...
  dest: Uint8Array<ArrayBufferLike> | Uint16Array<ArrayBuffer>,
  srcW: number,
  srcH: number,
  destW: number,
  filters: Int16Array<ArrayBuffer>,
) {
  let r, g, b, a
...
export function convolveVert(
  src: Uint8ClampedArray<ArrayBufferLike> | Uint16Array<ArrayBuffer>,
